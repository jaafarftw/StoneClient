public class Interfaces extends RSInterface {
	...
	public static void configureLunar(TextDrawingArea[] TDA) {
		...
		addLunar3RunesSmallBox(30064, 9075, 563, 557, 1, 0, 1, 30012, 30006, 68, "Monster Teleport","Teleport to training areas",TDA,6,0,5);
		addLunar3RunesBigBox(30075, 9075, 563, 557, 1, 0, 3, 30012,  30006, 69,"Minigame Teleport", "Teleport to various minigames",TDA, 7,0,5);
		addLunar3RunesSmallBox(30083, 9075, 563, 557, 1, 0, 5, 30012, 30006, 70, "Boss Teleport","Teleport to powerful foes",TDA,8,0,5);
		...
		addLunar3RunesSmallBox(30106, 9075, 563, 555,  1, 0,0, 30012, 30004, 71,"PvP Teleport", "Teleport Pking spots",TDA,11,0,5);
		addLunar3RunesBigBox(30114, 9075, 563, 555, 1, 0, 4, 30012, 30004, 72,"Skill Teleport", "Teleport to skilling areas",TDA, 12,0,5);
