    ...
    implements Runnable
{
    ...
    {
        boolean exists = (new File(System.getProperty("user.home") + "/skcache/")).exists();
        if (exists) {
            return System.getProperty("user.home") + "/skcache/";
        } else {
            File f = new File(System.getProperty("user.home") + "/skcache/");
            f.mkdir();
            return System.getProperty("user.home") + "/skcache/";
        }
    }
